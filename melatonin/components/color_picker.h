...
namespace melatonin
{
    ...
    public:
        ...
        void paint (juce::Graphics& g) override
        {
            ...
            g.setFont (juce::Font (juce::FontOptions ("Verdana", 9, juce::Font::FontStyleFlags::bold)));
    ...
    public:
        ...
        void paint (juce::Graphics& g) override
        {
            if (colorPickerButton.on)
            {
                ...
                g.setFont (juce::Font (juce::FontOptions ("Verdana", 14.5, juce::Font::FontStyleFlags::plain)));
            ...
            if (model.colors.empty())
            {
                ...
                g.setFont (juce::Font (juce::FontOptions ("Verdana", 15, juce::Font::FontStyleFlags::plain)));
